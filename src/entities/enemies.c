...
void updateBasicEnemies(BasicEnemy *enemy1, float delta)
{
    ...
    else
    {
        ...
        enemy1->speed.x *= 0.9; // reduz a velocidade at� o fim do tempo
    }
...
void updateAirBasicEnemies(AirBasicEnemy *enemy2, float delta)
{
    ...
    else
    {
        ...
        enemy2->speed.x *= 0.9; // reduz a velocidade at� o fim do tempo
    }
...
{
    if (enemy->knockbackStatus.knockbackR) //confere o tipo e dire��o
    {
        enemy->speed.x = -500.0; //aplica as for�as
        enemy->speed.y = -200.0;
...
void applyKnockbackToAirBasicEnemies(AirBasicEnemy *enemy)
{
    if (enemy->knockbackStatus.knockbackR) //confere o tipo e dire��o
    {
        enemy->speed.x = -250.0; //aplica as for�as
        enemy->speed.y = -100.0;
        enemy->knockbackStatus.knockbackTime = 0.5; // inicia o contador
    }
    if (enemy->knockbackStatus.knockbackL)
