...
PlayerSword createPlayerSword () //inicia a espada
{
    return (PlayerSword)
    {
        .pos = {0}, //deixa a posi��o zerada por enquanto
        .dim = (Vector2){0,0}, //tamanho
        .cor = WHITE, //cor
        .up = true, //booleanos que podem ser usados para determinar as dire��es possiveis do ataque
        .down = true,
        .left = true,
        .right = true,
...
void updatePlayerSword (Player *player) // atualiza a posi��o da espada ao atacar
{
