...
void loadResources()
{
    ...
    rm.player.sevenHearts = LoadTexture("Assets/Textures/7cora��es.png");
    rm.player.sixHearts = LoadTexture("Assets/Textures/6cora��es.png");
    rm.player.fiveHearts = LoadTexture("Assets/Textures/5cora��es.png");
    rm.player.fourHearts = LoadTexture("Assets/Textures/4cora��es.png");
    rm.player.treeHearts = LoadTexture("Assets/Textures/3cora��es.png");
    rm.player.twoHearts = LoadTexture("Assets/Textures/2cora��es.png");
    rm.player.oneHearts = LoadTexture("Assets/Textures/1cora��es.png");
    ...
    rm.player.sevenHeartsG = LoadTexture("Assets/Textures/7cora��esG.png");
    rm.player.sixHeartsG = LoadTexture("Assets/Textures/6cora��esG.png");
    rm.player.fiveHeartsG = LoadTexture("Assets/Textures/5cora��esG.png");
    rm.player.fourHeartsG = LoadTexture("Assets/Textures/4cora��esG.png");
    rm.player.treeHeartsG = LoadTexture("Assets/Textures/3cora��esG.png");
    rm.player.twoHeartsG = LoadTexture("Assets/Textures/2cora��esG.png");
    rm.player.oneHeartsG = LoadTexture("Assets/Textures/1cora��esG.png");
